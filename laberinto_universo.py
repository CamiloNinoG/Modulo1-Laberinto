...
def backtracking(laberinto, x, y, camino, energia, energia_por_celda):
    ...
    for agujero in laberinto['agujerosGusano']:
        if [x, y] == agujero['entrada']:
            ...
            return backtracking(laberinto, agujero['salida'][0], agujero['salida'][1], camino, energia, energia_por_celda)
    ...
    for dx, dy in [(1,0), (-1,0), (0,1), (0,-1)]:
        nx, ny = x + dx, y + dy
        if backtracking(laberinto, nx, ny, camino, energia, energia_por_celda):
            return True
...
def resolver_laberinto():
    ...
    encontrado = backtracking(datos, origen[0], origen[1], camino, energia_inicial, energia_por_celda)
